...
const SEED_ISSUES: Issue[] = [
  {
    ...
    latitude: 28.6139,
    longitude: 77.2090,
    address: "Near Main Intersection, Connaught Place, New Delhi",
    status: "In Progress",
    priority: 8,
    ai_confidence: 94,
    severity: "High",
  ...
  },
  {
    ...
    latitude: 28.5355,
    longitude: 77.2100,
    address: "Block C, Saket Residential Area, New Delhi",
    status: "Submitted",
    priority: 7,
    ai_confidence: 91,
    severity: "High",
  ...
  },
  {
    ...
    latitude: 28.7041,
    longitude: 77.1025,
    address: "Main Road, Rohini Sector 7, New Delhi",
    status: "Resolved",
    priority: 6,
    ai_confidence: 89,
    severity: "Medium",
  ...
  },
  {
    ...
    latitude: 28.5921,
    longitude: 77.0460,
    address: "Near Metro Station, Dwarka Sector 10, New Delhi",
    status: "Under Review",
    priority: 9,
    ai_confidence: 96,
    severity: "Critical",
